...
public function index(int $id,UrlGeneratorInterface $urlGenerator): Response
{
    ...
    $qrCode = QrCode::create(
        sprintf(
            ...
            $evenement->getId(),
            $evenement->getTitre(),
            $evenement->getDateEvenement()->format('Y-m-d H:i:s'),
            $evenement->getAdresse(),
            $evenement->getPrix(),
            $reservationUrl = $urlGenerator->generate('app_reservation_new', ['id' => $evenement->getId()], UrlGeneratorInterface::ABSOLUTE_URL)
        )
    ...
    $reservationUrl = $urlGenerator->generate('app_reservation_new', ['id' => $evenement->getId()]);
